...
const mostLikes = (blogs) => {
  ...
  const autorMasLikeado = Object.keys(likesCount).reduce((max, author) => {
    return likesCount[author] > (likesCount[max] || 0) ? author : max
  }, "")

  return {
    author: autorMasLikeado,
    likes: likesCount[autorMasLikeado]
  }
}
